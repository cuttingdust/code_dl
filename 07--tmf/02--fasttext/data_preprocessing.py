...
def preprocessing(datapath, process_datapath, is_char=True):
    ...
    print(f"process_datapath --> {process_datapath}")
    print(f"is_char --> {is_char}")
    print("-" * 150)
...
if __name__ == "__main__":
    ...
    preprocessing(
        ...
        process_datapath=config.process_char_train_datapath,
        is_char=True,
    )
    preprocessing(
        datapath=config.dev_datapath,
        process_datapath=config.process_char_dev_datapath,
        is_char=True,
    )
    preprocessing(
        datapath=config.test_datapath,
        process_datapath=config.process_char_test_datapath,
        is_char=True,
    )
    ...
    preprocessing(
        datapath=config.train_datapath,
        process_datapath=config.process_word_train_datapath,
        is_char=False,
    )
    preprocessing(
        datapath=config.dev_datapath,
        process_datapath=config.process_word_dev_datapath,
        is_char=False,
    )
    preprocessing(
        datapath=config.test_datapath,
        process_datapath=config.process_word_test_datapath,
        is_char=False,
    )
